...
function imagePreview() {
    $.post(base_url + 'controlador/do_upload', {}, function (file) {
        $("#imageUploaded").attr('src', 'http://localhost/imgProductos/' + file.val());
...
function comprarMas() {
    $.post(base_url + 'controlador/bazar', {}, function (pagina) {
        $("#info-center").html(pagina);
    });
}

//cargar productos seleccionados en el carro
function conteoCart() {
    $.post(base_url + 'controlador/conteoCart', {},
            function (pagina) {
                $("#user-Pedido").html(pagina);
            });
}

//funcion que llama a controlador par ir a vista de carrito
function verCarrito() {
    $.post(base_url + 'controlador/verCarrito', {}, function (pagina) {
        $("#info-center").html(pagina);
        conteoCart();
    });
}
...
function addProductCar(id) {
    $.post(base_url + 'controlador/addProductCart', {id: id},
            function () {
                conteoCart();
            });
}

function deletProductCart(rowid) {
    $.post(base_url + 'controlador/deletProductCart', {roid: rowid},
            function () {
                conteoCart();
            }
    );
...
function cancelCart() {
    $.post(base_url + 'controlador/cancelCart', {}, function (pagina) {
        $("#info-center").html(pagina);
        conteoCart();
    });
}
...
function newPedido() {
    $.post(base_url + 'controlador/verCarrito', {},
            function (pagina, datos) {
                $("#info-center").html(pagina, datos);
            });
}
